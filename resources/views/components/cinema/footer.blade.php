<footer class="bg-yellow-400 text-center text-black font-roboto">
    ...
    <div class="flex py-10 space-y-10 flex-col justify-center items-center">
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-10 mx-7">
            ...
            <div class="flex flex-col justify-center items-center space-y-5">
                <p class="text-2xl">Rólunk</p>
                <p class="text-justify text-lg">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam condimentum non ex in venenatis. Phasellus non purus neque. Cras non dolor tortor. Vestibulum lacus orci, sollicitudin vitae risus fringilla, ultricies lacinia dui. Duis non felis tincidunt risus dictum molestie vel in dolor. Morbi ligula ex, egestas vitae eros vel, gravida consectetur nibh. Cras finibus nisi vestibulum.
                </p>
            </div>
            <!-- First column: information -->
