<section id="add_screentime_form" class="bg-default-image bg-cover mt-20 sm:py-10 text-black font-roboto tracking-widest">
    <x-cinema.flash />
    <div class=" bg-yellow-400 sm:max-w-md mx-auto p-7 sm:rounded-lg my-auto">
        <div class="text-center text-2xl font-roboto-bold">Vetítés hozzáadása</div>
        <form method="POST" action="{{ Route('screentimes.store') }}">
            @csrf
            ...
            <div class="mb-3">
                ...
                <div class="relative mb-3" data-te-datepicker-init data-te-input-wrapper-init
                    ...
                    <input type="text" name="date"
                        ...
                        placeholder="Dátum kiválasztása" value="{{ old('date') }}" />
            ...
            <div class="mb-3">
                ...
                <div class="text-black bg-white rounded">
                    <select data-te-select-init name="presentation_type" data-te-select-filter="true"
                        data-te-select-placeholder="Válasszon ki egyet!" value="{{ old('presentation_type') }}">
            ...
            <div class="text-right mt-6">
                ...
                <button
                    class="bg-black text-white rounded py-2 px-4 ml-4 hover:bg-gray-600 hover:text-white">Hozzáadás</button>
            </div>
        </form>
    </div>
</section>
